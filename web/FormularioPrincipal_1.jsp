...
<html lang="en">
  ...
  <head>
    ...
    <title>SIGAP !US |Principal </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="FormularioPrincipal_1">Informacion</a></li>
                  ...
                  <li><a><i class="fa fa-edit"></i> Aministracion <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="FormilarioCliente_1.jsp">Nuevo Cliente</a></li>
                      <li><a href="FormularioMedidor_1.jsp">Medidores</a></li>
                    ...
                    <ul class="nav child_menu">
                      <li><a href="FormularioConsumo_1.jsp">Nueva Medicion</a></li>
                      
                    </ul>
                  </li>
                  <li><a><i class="fa fa-ticket"></i> Facturacion<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="FormularioFactura_1.jsp">Generar Factura</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Reportes <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="FormularioReporteCliente_1.jsp">Reporte de Clientes</a></li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-google"></i> Ley de Recursos Hídricos<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="https://www.agua.gob.ec/wp-content/uploads/2012/10/LEYD-E-RECURSOS-HIDRICOS-II-SUPLEMENTO-RO-305-6-08-204.pdf">Ley de Recursos Hídricos II suplemento RO 305 6-08-204</a></li>
                      <li><a href="https://www.agua.gob.ec/wp-content/uploads/2012/10/NORMATIVA-SECUNDARIA.pdf">Normativa Secundaria</a></li>
                      <li><a href="https://www.agua.gob.ec/wp-content/uploads/2012/10/REGLAMENTO-LEY-RECURSOS-HIDRICOS-USOS-Y-APROVECHAMIENTO-DEL-AGUApdf.pdf">Reglamento ley Recursos Hidricos usos y aprovechamiento del agua</a></li>
                      <li><a href="https://www.agua.gob.ec/">Secretaria Nacional del Agua</a></li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Cerrar Sesion" href="FormularioLogeo.jsp">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="FormularioLogeo.jsp"><i class="fa fa-sign-out pull-right"></i> Cerrar Sesion</a></li>
                  </ul>
                </li>
