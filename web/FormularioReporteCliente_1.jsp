<%-- 
    Document   : FormularioReporteCliente
    Created on : 26/07/2018, 11:16:51
    Author     : jhona
--%>
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-table"></i> Reportes <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            ...
                                            <form action="MostrarCliente">
                                            <input type="submit" value="Reporte Clientes" />
                                            </form>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                .<h3>SIGAP <small>Reporte de Usuarios Registrados </small></h3>
                            </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Tabla de Clientes <small></small></h2>
                                ...
                                <div class="x_content">
                                    <p class="text-muted font-13 m-b-30">
                                        En esta tabla se muestran todos los clientes registrados en el sistema SIGAP,si desea un reporte de todos los clientes tiene las opciones de exportacion.
                                    </p>
